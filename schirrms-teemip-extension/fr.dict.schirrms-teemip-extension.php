...
//
// Class: GenericCommVirtInterface
//
...
Dict::Add('FR FR', 'French', 'Français', array(
        ...
        'Class:GenericCommVirtInterface/Attribute:status' => 'Statut',
        'Class:GenericCommVirtInterface/Attribute:status+' => '',
        'Class:GenericCommVirtInterface/Attribute:status/Value:active' => 'Active',
        'Class:GenericCommVirtInterface/Attribute:status/Value:active+' => '',
        'Class:GenericCommVirtInterface/Attribute:status/Value:inactive' => 'Inactive',
        'Class:GenericCommVirtInterface/Attribute:status/Value:inactive+' => '',
));
...
Dict::Add('FR FR', 'French', 'Français', array(
        'Class:lnkGenericCommInterfaceToVLAN' => 'Lien Interface réseau / VLAN',
        'Class:lnkGenericCommInterfaceToVLAN+' => '',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_id' => 'Interface de comm',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_id+' => '',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_name' => 'Nom interface de comm',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_name+' => '',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_device_id' => 'Equipement',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_device_id+' => '',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_device_name' => 'Nom équipement',
        'Class:lnkGenericCommInterfaceToVLAN/Attribute:GenericCommInterface_device_name+' => '',
